...
export async function GET() {
  try {
    ...
    const headers = {
      ...
      grade: h[11] || "학년", // L열 (11)
      studentId: h[16] || "학번", // N열 (16)
      realDropDate: h[14] || "퇴원관리자", // O열 (14)
      lastAttend: h[15] || "처리자", // P열 (15)
      ...
      // --- ✏️ 담당자 작성(입력) 영역 ---
      vReason1: h[21] || "퇴원종류(분류1)", // W열 (22)
      wReason2: h[22] || "퇴원사유(분류2)", // X열 (23)
      xFileLink: h[23] || "상세사유", // Y열 (24)
      yDetail: h[24] || "증빙", // Z열 (25)
